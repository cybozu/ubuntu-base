...
| libc-dev-bin | 2.35-0ubuntu3.13 | GNU C Library: Development binaries |
...
| libssl-dev:amd64 | 3.0.2-0ubuntu1.23 | Secure Sockets Layer toolkit - development files |
...
| linux-libc-dev:amd64 | 5.15.0-177.187 | Linux Kernel Headers for development |
