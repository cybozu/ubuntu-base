...
| g++-11 | 11.4.0-1ubuntu1~22.04 | GNU C++ compiler |
...
| libatomic1:amd64 | 12.3.0-1ubuntu1~22.04 | support library providing __atomic built-in functions |
...
| libc-dev-bin | 2.35-0ubuntu3.10 | GNU C Library: Development binaries |
| libc6:amd64 | 2.35-0ubuntu3.10 | GNU C Library: Shared libraries |
| libc6-dev:amd64 | 2.35-0ubuntu3.10 | GNU C Library: Development Libraries and Header Files |
...
| libcc1-0:amd64 | 12.3.0-1ubuntu1~22.04 | GCC cc1 plugin for GDB |
...
| libgcc-11-dev:amd64 | 11.4.0-1ubuntu1~22.04 | GCC support library (development files) |
...
| libgomp1:amd64 | 12.3.0-1ubuntu1~22.04 | GCC OpenMP (GOMP) support library |
...
| liblsan0:amd64 | 12.3.0-1ubuntu1~22.04 | LeakSanitizer -- a memory leak detector (runtime) |
...
| libtsan0:amd64 | 11.4.0-1ubuntu1~22.04 | ThreadSanitizer -- a Valgrind-based detector of data races (runtime) |
| libubsan1:amd64 | 12.3.0-1ubuntu1~22.04 | UBSan -- undefined behaviour sanitizer (runtime) |
...
| linux-libc-dev:amd64 | 5.15.0-142.152 | Linux Kernel Headers for development |
