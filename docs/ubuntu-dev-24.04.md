...
| curl | 8.5.0-2ubuntu10.12 | command line tool for transferring data with URL syntax |
...
| libc-dev-bin | 2.39-0ubuntu8.8 | GNU C Library: Development binaries |
| libc6:amd64 | 2.39-0ubuntu8.8 | GNU C Library: Shared libraries |
| libc6-dev:amd64 | 2.39-0ubuntu8.8 | GNU C Library: Development Libraries and Header Files |
...
| libcurl3t64-gnutls:amd64 | 8.5.0-2ubuntu10.12 | easy-to-use client-side URL transfer library (GnuTLS flavour) |
| libcurl4t64:amd64 | 8.5.0-2ubuntu10.12 | easy-to-use client-side URL transfer library (OpenSSL flavour) |
...
| libssl-dev:amd64 | 3.0.13-0ubuntu3.12 | Secure Sockets Layer toolkit - development files |
