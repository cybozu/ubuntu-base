...
| binutils | 2.42-4ubuntu2.7 | GNU assembler, linker and binary utilities |
| binutils-common:amd64 | 2.42-4ubuntu2.7 | Common files for the GNU assembler, linker and binary utilities |
| binutils-x86-64-linux-gnu | 2.42-4ubuntu2.7 | GNU binary utilities, for x86-64-linux-gnu target |
...
| libbinutils:amd64 | 2.42-4ubuntu2.7 | GNU binary utilities (private shared library) |
...
| libctf-nobfd0:amd64 | 2.42-4ubuntu2.7 | Compact C Type Format library (runtime, no BFD dependency) |
| libctf0:amd64 | 2.42-4ubuntu2.7 | Compact C Type Format library (runtime, BFD dependency) |
...
| libgprofng0:amd64 | 2.42-4ubuntu2.7 | GNU Next Generation profiler (runtime library) |
...
| libsframe1:amd64 | 2.42-4ubuntu2.7 | Library to handle the SFrame format (runtime library) |
