...
| base-files | 13ubuntu10.5 | Debian base system miscellaneous files |
...
| iproute2 | 6.1.0-1ubuntu6.4 | networking and traffic control tools |
...
| libc-bin | 2.39-0ubuntu8.9 | GNU C Library: Binaries |
| libc6:amd64 | 2.39-0ubuntu8.9 | GNU C Library: Shared libraries |
...
| libglib2.0-0t64:amd64 | 2.80.0-6ubuntu3.9 | GLib library of C routines |
...
| libgssapi-krb5-2:amd64 | 1.20.1-6ubuntu2.10 | MIT Kerberos runtime libraries - krb5 GSS-API Mechanism |
...
| libk5crypto3:amd64 | 1.20.1-6ubuntu2.10 | MIT Kerberos runtime libraries - Crypto Library |
| libkeyutils1:amd64 | 1.6.3-3build1 | Linux Key Management Utilities (library) |
| libkrb5-3:amd64 | 1.20.1-6ubuntu2.10 | MIT Kerberos runtime libraries |
| libkrb5support0:amd64 | 1.20.1-6ubuntu2.10 | MIT Kerberos runtime libraries - Support library |
...
| libpython3.12-minimal:amd64 | 3.12.3-1ubuntu0.17 | Minimal subset of the Python language (version 3.12) |
| libpython3.12-stdlib:amd64 | 3.12.3-1ubuntu0.17 | Interactive high-level object-oriented language (standard library, version 3.12) |
| libpython3.12t64:amd64 | 3.12.3-1ubuntu0.17 | Shared Python runtime library (version 3.12) |
...
| python3.12-minimal | 3.12.3-1ubuntu0.17 | Minimal subset of the Python language (version 3.12) |
| rclone | 1.60.1+dfsg-3ubuntu0.24.04.6 | rsync for commercial cloud storage |
