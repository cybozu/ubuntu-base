...
| apache2-utils | 2.4.58-1ubuntu8.11 | Apache HTTP Server (utility programs for web servers) |
...
| bind9-dnsutils | 1:9.18.39-0ubuntu0.24.04.3 | Clients provided with BIND 9 |
| bind9-host | 1:9.18.39-0ubuntu0.24.04.3 | DNS Lookup Utility |
| bind9-libs:amd64 | 1:9.18.39-0ubuntu0.24.04.3 | Shared Libraries used by BIND 9 |
...
| vim | 2:9.1.0016-1ubuntu7.10 | Vi IMproved - enhanced vi editor |
| vim-common | 2:9.1.0016-1ubuntu7.10 | Vi IMproved - Common files |
| vim-runtime | 2:9.1.0016-1ubuntu7.10 | Vi IMproved - Runtime files |
...
| awscli | 2.34.26 | Universal Command Line Interface for Amazon Web Services |
