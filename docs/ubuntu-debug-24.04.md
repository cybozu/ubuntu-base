...
| apache2-utils | 2.4.58-1ubuntu8.12 | Apache HTTP Server (utility programs for web servers) |
...
| bind9-dnsutils | 1:9.18.39-0ubuntu0.24.04.5 | Clients provided with BIND 9 |
| bind9-host | 1:9.18.39-0ubuntu0.24.04.5 | DNS Lookup Utility |
| bind9-libs:amd64 | 1:9.18.39-0ubuntu0.24.04.5 | Shared Libraries used by BIND 9 |
...
| awscli | 2.34.52 | Universal Command Line Interface for Amazon Web Services |
