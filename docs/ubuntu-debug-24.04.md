...
| apache2-utils | 2.4.58-1ubuntu8.6 | Apache HTTP Server (utility programs for web servers) |
...
| mysql-client | 8.0.42-0ubuntu0.24.04.1 | MySQL database client (metapackage depending on the latest version) |
| mysql-client-8.0 | 8.0.42-0ubuntu0.24.04.1 | MySQL database client binaries |
| mysql-client-core-8.0 | 8.0.42-0ubuntu0.24.04.1 | MySQL database core client binaries |
...
| awscli | 2.27.49 | Universal Command Line Interface for Amazon Web Services |
