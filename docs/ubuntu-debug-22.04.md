...
| apache2-utils | 2.4.52-1ubuntu4.14 | Apache HTTP Server (utility programs for web servers) |
...
| libpython3.10:amd64 | 3.10.12-1~22.04.10 | Shared Python runtime library (version 3.10) |
| libpython3.10-minimal:amd64 | 3.10.12-1~22.04.10 | Minimal subset of the Python language (version 3.10) |
| libpython3.10-stdlib:amd64 | 3.10.12-1~22.04.10 | Interactive high-level object-oriented language (standard library, version 3.10) |
...
| libxml2:amd64 | 2.9.13+dfsg-1ubuntu0.7 | GNOME XML library |
...
| mysql-client | 8.0.42-0ubuntu0.22.04.1 | MySQL database client (metapackage depending on the latest version) |
| mysql-client-8.0 | 8.0.42-0ubuntu0.22.04.1 | MySQL database client binaries |
| mysql-client-core-8.0 | 8.0.42-0ubuntu0.22.04.1 | MySQL database core client binaries |
...
| sqlite3 | 3.37.2-2ubuntu0.4 | Command line interface for SQLite 3 |
