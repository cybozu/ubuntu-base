...
| binutils | 2.38-4ubuntu2.10 | GNU assembler, linker and binary utilities |
| binutils-common:amd64 | 2.38-4ubuntu2.10 | Common files for the GNU assembler, linker and binary utilities |
| binutils-x86-64-linux-gnu | 2.38-4ubuntu2.10 | GNU binary utilities, for x86-64-linux-gnu target |
...
| libbinutils:amd64 | 2.38-4ubuntu2.10 | GNU binary utilities (private shared library) |
...
| libctf-nobfd0:amd64 | 2.38-4ubuntu2.10 | Compact C Type Format library (runtime, no BFD dependency) |
| libctf0:amd64 | 2.38-4ubuntu2.10 | Compact C Type Format library (runtime, BFD dependency) |
...
| libpython3.10:amd64 | 3.10.12-1~22.04.11 | Shared Python runtime library (version 3.10) |
...
| mysql-client | 8.0.44-0ubuntu0.22.04.1 | MySQL database client (metapackage depending on the latest version) |
| mysql-client-8.0 | 8.0.44-0ubuntu0.22.04.1 | MySQL database client binaries |
| mysql-client-core-8.0 | 8.0.44-0ubuntu0.22.04.1 | MySQL database core client binaries |
